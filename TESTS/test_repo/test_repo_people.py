...
class test_repo_people(unittest.TestCase):
    ...
    def test_add_person(self):
        person1 = person_class("1", "John Doe", "USA", "New York", "Broadway", "12", self.__shared_person_event_class)
        person2 = person_class("1", "Jane Smith", "UK", "London", "Baker Street", "221B", self.__shared_person_event_class)
    ...
    def test_remove_person(self):
        person = person_class("1", "John Doe", "USA", "New York", "Broadway", "12", self.__shared_person_event_class)
    ...
    def test_update_person(self):
        person = person_class("1", "John Doe", "USA", "New York", "Broadway", "12", self.__shared_person_event_class)
        updated_person = person_class("2", "Jane Smith", "UK", "London", "Baker Street", "221B", self.__shared_person_event_class)
        self.__repo.add_person_to_rep(person)
    ...
    def test_update_person_inexistent_id(self):
        updated_person = person_class("1", "Jane Smith", "UK", "London", "Baker Street", "221B", self.__shared_person_event_class)
        with self.assertRaises(inexistent_person_id_exception):
    ...
    def test_get_list_of_DTO_objs(self):
        person1 = person_class("1", "John Doe", "USA", "New York", "Broadway", "12", self.__shared_person_event_class)
        person2 = person_class("2", "Jane Smith", "UK", "London", "Baker Street", "221B", self.__shared_person_event_class)
        self.__repo.add_person_to_rep(person1)
        self.__repo.add_person_to_rep(person2)
